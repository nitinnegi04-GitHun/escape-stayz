...
export const CTASection: React.FC<CTASectionProps> = ({
    ...
    const finalLink = button_link === 'whatsapp' && settings?.contact?.phone
    ...
    return (
        ...
        >
            ...
            >
                <h2 className="text-4xl md:text-6xl text-black/80 font-heading font-extrabold mb-8 drop-shadow-xl">{heading}</h2>
                ...
                >
                    <Button href={finalLink}>{button_text}</Button>
                </motion.div>
            </motion.div>
        </section>
    );
